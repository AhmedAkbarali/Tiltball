 ...
 *
 * Login ID - delush
 * Student ID - 213639166
 * Last name - Akbarali
 * First name(s) - Ahmed
 */
public class DemoTiltBalldelushActivity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        rb.configure(pathType, pathWidth, gain, totalLaps, orderOfControl);
